...
public class Bateau extends Transport {
	...
	public Bateau(String escale, String date_Depart, String date_Arrive, String heure_Depart, String heure_Arrive,
			double prix) {
	...
	public Bateau(String escale, String date_Depart, String date_Arrive, String heure_Depart, String heure_Arrive,
			double prix, String quai_Depart, String quai_Arrive) {
		super(escale, date_Depart, date_Arrive, heure_Depart, heure_Arrive, prix);
